...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/Shwet-Kamal-Singh/vpn/tree/main/openvpn"
	echo ""
	...
	echo "See https://github.com/Shwet-Kamal-Singh/vpn/tree/main/openvpn#security-and-encryption to learn more."
	echo ""
